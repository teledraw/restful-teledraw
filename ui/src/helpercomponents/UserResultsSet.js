...
export default function UserResultsSet(props) {
    ...
    function imageOrPhrasePlusLeaderText(index, submission) {
        return index % 2 === 0 ? <><div className="row-item">" {submission} "</div><div className="row-item">Leading to...</div></> : <><img className="row-item" src={submission} alt=""/><div className="row-item">Leading to...</div></>;
    }
